...
export class CSpellgameSky extends CBaseEntity{
    ...
    constructor(scene: CScene){
        ...
        super( scene, new THREE.Mesh( new THREE.BoxBufferGeometry( 1, 1, 1 ), material ) );
...
var SkyShader = {
	...
	vertexShader: [
		...
		'	vSunfade = 1.0 - clamp( 1.0 - exp( ( sunPosition.y / 4500 ) ), 0.0, 1.0 );',
	...
	fragmentShader: [
		...
		'	gl_FragColor = vec4( retColor + vec3(0.0,0.5,0.0), 1.0 );',
		'}'
	].join( '\n' )
