...
import EffectComposer, { RenderPass, ShaderPass, Pass } from '@johh/three-effectcomposer'

export var UnrealBloomPass = function ( resolution, strength, radius, threshold ) {
